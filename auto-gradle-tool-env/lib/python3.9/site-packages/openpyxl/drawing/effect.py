...
class OuterShadow(ColorChoice):
    ...
    def __init__(
        self, blurRad=None, dist=None, dir=None, sx=None, sy=None, kx=None, ky=None, algn=None, rotWithShape=None, **kw
    ):
        self.blurRad = blurRad
        self.dist = dist
        self.dir = dir
...
class EffectList(Serialisable):
    ...
    __elements__ = ("blur", "fillOverlay", "glow", "innerShdw", "outerShdw", "prstShdw", "reflection", "softEdge")
