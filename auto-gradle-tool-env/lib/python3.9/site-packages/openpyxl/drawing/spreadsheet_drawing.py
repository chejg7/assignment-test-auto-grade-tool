...
class _AnchorBase(Serialisable):
    ...
    __elements__ = ("sp", "grpSp", "graphicFrame", "cxnSp", "pic", "contentPart", "clientData")

    def __init__(
        self, clientData=None, sp=None, grpSp=None, graphicFrame=None, cxnSp=None, pic=None, contentPart=None
    ):
