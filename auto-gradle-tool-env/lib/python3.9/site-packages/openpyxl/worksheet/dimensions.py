...
class Dimension(Strict, StyleableObject):
    ...
    def __init__(self, index, hidden, outlineLevel, collapsed, worksheet, visible=True, style=None):
...
class RowDimension(Dimension):
    ...
    __fields__ = Dimension.__fields__ + ("ht", "customFormat", "customHeight", "s", "thickBot", "thickTop")
    r = Alias("index")
    s = Alias("style_id")
    ...
    def __init__(
        ...
        **kw
        ...
        super(RowDimension, self).__init__(index, hidden, outlineLevel, collapsed, worksheet, style=s)
...
class ColumnDimension(Dimension):
    ...
    __fields__ = Dimension.__fields__ + ("width", "bestFit", "customWidth", "style", "min", "max")
    ...
    def __init__(
        ...
        if outline_level is not None:
            outlineLevel = outline_level
        self.collapsed = collapsed
        super(ColumnDimension, self).__init__(index, hidden, outlineLevel, collapsed, worksheet, style=style)
