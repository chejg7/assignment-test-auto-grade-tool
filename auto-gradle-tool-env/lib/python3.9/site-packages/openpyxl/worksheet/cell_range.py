...
class CellRange(Serialisable):
    ...
    def __init__(self, range_string=None, min_col=None, min_row=None, max_col=None, max_row=None, title=None):
    ...
    def __copy__(self):
        return self.__class__(
            min_col=self.min_col, min_row=self.min_row, max_col=self.max_col, max_row=self.max_row, title=self.title
        )
    ...
    def isdisjoint(self, other):
        ...
        return self.max_col < other.min_col or self.max_row < other.min_row or other.max_row < self.min_row
    ...
    def union(self, other):
        ...
        return CellRange(min_col=min_col, min_row=min_row, max_col=max_col, max_row=max_row, title=self.title)
