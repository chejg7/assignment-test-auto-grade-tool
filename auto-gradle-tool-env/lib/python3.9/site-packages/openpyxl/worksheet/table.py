...
class TableColumn(Serialisable):
    ...
    name = String()
    totalsRowFunction = NoneSet(
        values=(["sum", "min", "max", "average", "count", "countNums", "stdDev", "var", "custom"])
    )
    ...
    __elements__ = ("calculatedColumnFormula", "totalsRowFormula", "xmlColumnPr", "extLst")
