...
class Border(Serialisable):
    ...
    __fields__ = ("left", "right", "top", "bottom", "diagonal", "diagonal_direction", "vertical", "horizontal")
    __elements__ = ("start", "end", "left", "right", "top", "bottom", "diagonal", "vertical", "horizontal")
