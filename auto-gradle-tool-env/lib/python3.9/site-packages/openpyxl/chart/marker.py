...
class Marker(Serialisable):
    ...
    symbol = NestedNoneSet(
        values=(["circle", "dash", "diamond", "dot", "picture", "plus", "square", "star", "triangle", "x", "auto"]),
...
class DataPoint(Serialisable):
    ...
    __elements__ = ("idx", "invertIfNegative", "marker", "bubble3D", "explosion", "spPr", "pictureOptions")
