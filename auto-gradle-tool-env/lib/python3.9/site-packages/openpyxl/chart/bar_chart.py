...
class _BarChartBase(ChartBase):
    ...
    type = Alias("barDir")
    grouping = NestedSet(values=(["percentStacked", "clustered", "standard", "stacked"]))
    ...
    def __init__(self, barDir="col", grouping="clustered", varyColors=None, ser=(), dLbls=None, **kw):
        self.barDir = barDir
...
class BarChart3D(_BarChartBase, _3DBase):
    ...
    def __init__(self, gapWidth=150, gapDepth=150, shape=None, serLines=None, extLst=None, **kw):
        self.gapWidth = gapWidth
