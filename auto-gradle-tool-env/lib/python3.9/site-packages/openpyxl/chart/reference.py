...
from openpyxl.utils import get_column_letter, range_to_tuple, quote_sheetname
...
class Reference(Strict):
    ...
    def __init__(self, worksheet=None, min_col=None, min_row=None, max_col=None, max_row=None, range_string=None):
