...
class _LineChartBase(ChartBase):
    ...
    def __init__(self, grouping="standard", varyColors=None, ser=(), dLbls=None, dropLines=None, **kw):
...
class LineChart(_LineChartBase):
    ...
    def __init__(self, hiLowLines=None, upDownBars=None, marker=None, smooth=None, extLst=None, **kw):
...
class LineChart3D(_LineChartBase):
    ...
    __elements__ = _LineChartBase.__elements__ + ("gapDepth", "hiLowLines", "upDownBars", "marker", "smooth", "axId")

    def __init__(self, gapDepth=None, hiLowLines=None, upDownBars=None, marker=None, smooth=None, **kw):
