...
class ShapeWriter(object):
    ...
    def add_comment_shapetype(self, root):
        ...
        SubElement(shape_type, "{%s}path" % vmlns, {"gradientshapeok": "t", "{%s}connecttype" % officens: "rect"})
...
def _shape_factory(row, column, height, width):
    ...
    attrs = {"type": "#_x0000_t202", "style": style, "fillcolor": "#ffffe1", "{%s}insetmode" % officens: "auto"}
