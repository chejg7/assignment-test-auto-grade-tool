    ...
    def write_names(self):
        ...
        for idx, sheet in enumerate(self.wb.worksheets):
            ...
            if auto_filter:
                ...
                name.value = "{0}!{1}".format(quote_sheetname(sheet.title), absolute_coordinate(auto_filter))
            ...
            if sheet.print_titles:
                ...
                name.value = ",".join(
                    ["{0}!{1}".format(quote_sheetname(sheet.title), r) for r in sheet.print_titles.split(",")]
                )
                defined_names.append(name)
            ...
            if sheet.print_area:
                ...
                name.value = ",".join(["{0}!{1}".format(quote_sheetname(sheet.title), r) for r in sheet.print_area])
                defined_names.append(name)
