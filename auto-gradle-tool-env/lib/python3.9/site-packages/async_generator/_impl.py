...
import inspect
from inspect import getcoroutinestate, CORO_CREATED, CORO_CLOSED, CORO_SUSPENDED
...
try:
    ...
    asyncgen_hooks = collections.namedtuple("asyncgen_hooks", ("firstiter", "finalizer"))
            ...
            if self._finalizer is not None:
                ...
                try:
                    ...
                    raise RuntimeError(
                        ...
                        "'async with aclosing(...):'".format(self.ag_code.co_name)
                    )
                finally:
                    thrower.close()
