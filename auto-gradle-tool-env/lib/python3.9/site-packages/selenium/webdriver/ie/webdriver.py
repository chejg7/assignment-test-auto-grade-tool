...
class WebDriver(RemoteWebDriver):
    ...
    def __init__(
        ...
        if port != DEFAULT_PORT:
            warnings.warn(
                "port has been deprecated, please pass in a Service object", DeprecationWarning, stacklevel=2
            )
        ...
        if host != DEFAULT_HOST:
            warnings.warn(
                "host has been deprecated, please pass in a Service object", DeprecationWarning, stacklevel=2
            )
