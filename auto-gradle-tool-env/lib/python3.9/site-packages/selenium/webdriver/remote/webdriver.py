...
class WebDriver(BaseWebDriver):
    ...
    def desired_capabilities(self) -> dict:
        ...
        """
        warnings.warn(
            "desired_capabilities is deprecated. Please call capabilities.", DeprecationWarning, stacklevel=2
        )
        return self.caps
    ...
    def set_user_verified(self, verified: bool) -> None:
        ...
        """
        self.execute(
            Command.SET_USER_VERIFIED, {"authenticatorId": self._authenticator_id, "isUserVerified": verified}
        )
