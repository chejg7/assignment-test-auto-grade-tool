...
def get_possible_breakpoints(
    start: Location, end: typing.Optional[Location] = None, restrict_to_function: typing.Optional[bool] = None
...
def set_breakpoint_by_url(
    ...
    json = yield cmd_dict
    return (BreakpointId.from_json(json["breakpointId"]), [Location.from_json(i) for i in json["locations"]])
...
def set_script_source(
    script_id: runtime.ScriptId, script_source: str, dry_run: typing.Optional[bool] = None
) -> typing.Generator[
    T_JSON_DICT,
    T_JSON_DICT,
    typing.Tuple[
...
def set_variable_value(
    scope_number: int, variable_name: str, new_value: runtime.CallArgument, call_frame_id: CallFrameId
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    """
...
def step_into(
    break_on_async_call: typing.Optional[bool] = None, skip_list: typing.Optional[typing.List[LocationRange]] = None
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    """
...
class BreakpointResolved:
    ...
    def from_json(cls, json: T_JSON_DICT) -> BreakpointResolved:
        return cls(
            breakpoint_id=BreakpointId.from_json(json["breakpointId"]), location=Location.from_json(json["location"])
        )
...
class ScriptFailedToParse:
    ...
    def from_json(cls, json: T_JSON_DICT) -> ScriptFailedToParse:
        return cls(
            ...
            script_language=debugger.ScriptLanguage.from_json(json["scriptLanguage"])
