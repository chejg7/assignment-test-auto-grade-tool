...
class RemoteObject:
    ...
    def from_json(cls, json):
        return cls(
            ...
            unserializable_value=UnserializableValue.from_json(json["unserializableValue"])
...
def compile_script(
    ...
    T_JSON_DICT, T_JSON_DICT, typing.Tuple[typing.Optional[ScriptId], typing.Optional[ExceptionDetails]]
]:
    """
    Compiles expression.
...
def add_binding(
    name: str, execution_context_id: typing.Optional[ExecutionContextId] = None
