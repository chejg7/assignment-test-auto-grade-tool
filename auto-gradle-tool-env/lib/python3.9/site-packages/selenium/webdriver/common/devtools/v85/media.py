...
class PlayerEventsAdded:
    ...
    def from_json(cls, json: T_JSON_DICT) -> PlayerEventsAdded:
        return cls(
            player_id=PlayerId.from_json(json["playerId"]), events=[PlayerEvent.from_json(i) for i in json["events"]]
        )
...
class PlayerErrorsRaised:
    ...
    def from_json(cls, json: T_JSON_DICT) -> PlayerErrorsRaised:
        return cls(
            player_id=PlayerId.from_json(json["playerId"]), errors=[PlayerError.from_json(i) for i in json["errors"]]
        )
