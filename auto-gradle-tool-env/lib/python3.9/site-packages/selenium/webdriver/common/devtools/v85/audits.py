    ...
    def from_json(cls, json):
        return cls(
            ...
            cookie_exclusion_reasons=[
                SameSiteCookieExclusionReason.from_json(i) for i in json["cookieExclusionReasons"]
            ],
...
class InspectorIssueDetails:
    ...
    def from_json(cls, json):
        return cls(
            same_site_cookie_issue_details=SameSiteCookieIssueDetails.from_json(json["sameSiteCookieIssueDetails"])
