...
class DeprecationIssueDetails:
    ...
    deprecation_type: typing.Optional[str] = None
    ...
    def to_json(self):
        ...
        if self.deprecation_type is not None:
    ...
    def from_json(cls, json):
        return cls(
            ...
            deprecation_type=str(json["deprecationType"]) if "deprecationType" in json else None,
        )
