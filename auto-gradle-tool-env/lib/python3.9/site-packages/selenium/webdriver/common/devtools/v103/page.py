...
class AdFrameStatus:
    ...
    def from_json(cls, json):
        return cls(
            ...
            explanations=[AdFrameExplanation.from_json(i) for i in json["explanations"]]
...
class FrameResourceTree:
    ...
    def from_json(cls, json):
        return cls(
            ...
            child_frames=[FrameResourceTree.from_json(i) for i in json["childFrames"]]
...
class PrerenderFinalStatus(enum.Enum):
    ...
    EMBEDDER_TRIGGERED_AND_DESTROYED = "EmbedderTriggeredAndDestroyed"
...
def add_script_to_evaluate_on_new_document(
    source: str, world_name: typing.Optional[str] = None, include_command_line_api: typing.Optional[bool] = None
...
def create_isolated_world(
    frame_id: FrameId, world_name: typing.Optional[str] = None, grant_univeral_access: typing.Optional[bool] = None
...
def get_app_manifest() -> typing.Generator[
    ...
    T_JSON_DICT,
    typing.Tuple[
        str, typing.List[AppManifestError], typing.Optional[str], typing.Optional[AppManifestParsedProperties]
    ],
]:
    """
...
def get_layout_metrics() -> typing.Generator[
    T_JSON_DICT,
    T_JSON_DICT,
    typing.Tuple[LayoutViewport, VisualViewport, dom.Rect, LayoutViewport, VisualViewport, dom.Rect],
]:
    """
...
def reload(
    ignore_cache: typing.Optional[bool] = None, script_to_evaluate_on_load: typing.Optional[str] = None
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    """
...
def set_font_families(
    font_families: FontFamilies, for_scripts: typing.Optional[typing.List[ScriptFontFamilies]] = None
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    """
    ...
    def from_json(cls, json: T_JSON_DICT) -> BackForwardCacheNotUsed:
        return cls(
            ...
            not_restored_explanations=[
                BackForwardCacheNotRestoredExplanation.from_json(i) for i in json["notRestoredExplanations"]
            ],
            not_restored_explanations_tree=BackForwardCacheNotRestoredExplanationTree.from_json(
