...
class CSSRule:
    ...
    def from_json(cls, json):
        return cls(
            ...
            container_queries=[CSSContainerQuery.from_json(i) for i in json["containerQueries"]]
...
class FontFace:
    ...
    def from_json(cls, json):
        return cls(
            ...
            font_variation_axes=[FontVariationAxis.from_json(i) for i in json["fontVariationAxes"]]
...
def add_rule(
    style_sheet_id: StyleSheetId, rule_text: str, location: SourceRange
...
def get_matched_styles_for_node(
    ...
    return (
        ...
        [InheritedPseudoElementMatches.from_json(i) for i in json["inheritedPseudoElements"]]
