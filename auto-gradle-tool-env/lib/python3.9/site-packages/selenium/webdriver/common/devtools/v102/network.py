...
class Request:
    ...
    def from_json(cls, json):
        return cls(
            ...
            post_data_entries=[PostDataEntry.from_json(i) for i in json["postDataEntries"]]
            if "postDataEntries" in json
            else None,
            mixed_content_type=security.MixedContentType.from_json(json["mixedContentType"])
            if "mixedContentType" in json
            else None,
            is_link_preload=bool(json["isLinkPreload"]) if "isLinkPreload" in json else None,
            trust_token_params=TrustTokenParams.from_json(json["trustTokenParams"])
    ...
    def from_json(cls, json):
        return cls(
            ...
            signed_certificate_timestamp_list=[
                SignedCertificateTimestamp.from_json(i) for i in json["signedCertificateTimestampList"]
            ],
...
class Response:
    ...
    def from_json(cls, json):
        return cls(
            ...
            service_worker_response_source=ServiceWorkerResponseSource.from_json(json["serviceWorkerResponseSource"])
...
class RequestPattern:
    ...
    def from_json(cls, json):
        return cls(
            ...
            interception_stage=InterceptionStage.from_json(json["interceptionStage"])
...
class CrossOriginOpenerPolicyStatus:
    ...
    def from_json(cls, json):
        return cls(
            ...
            report_only_reporting_endpoint=str(json["reportOnlyReportingEndpoint"])
...
def delete_cookies(
    name: str, url: typing.Optional[str] = None, domain: typing.Optional[str] = None, path: typing.Optional[str] = None
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    """
...
def load_network_resource(
    frame_id: typing.Optional[page.FrameId] = None, url: str = None, options: LoadNetworkResourceOptions = None
...
class LoadingFailed:
    ...
    def from_json(cls, json: T_JSON_DICT) -> LoadingFailed:
        return cls(
            ...
            cors_error_status=CorsErrorStatus.from_json(json["corsErrorStatus"])
...
class LoadingFinished:
    ...
    def from_json(cls, json: T_JSON_DICT) -> LoadingFinished:
        return cls(
            ...
            if "shouldReportCorbBlocking" in json
            else None,
        )
...
class WebSocketClosed:
    ...
    def from_json(cls, json: T_JSON_DICT) -> WebSocketClosed:
        return cls(
            request_id=RequestId.from_json(json["requestId"]), timestamp=MonotonicTime.from_json(json["timestamp"])
        )
...
class WebTransportConnectionEstablished:
    ...
    def from_json(cls, json: T_JSON_DICT) -> WebTransportConnectionEstablished:
        return cls(
            transport_id=RequestId.from_json(json["transportId"]), timestamp=MonotonicTime.from_json(json["timestamp"])
        )
    ...
    **EXPERIMENTAL**
    ...
    def from_json(cls, json: T_JSON_DICT) -> RequestWillBeSentExtraInfo:
        return cls(
            ...
            client_security_state=ClientSecurityState.from_json(json["clientSecurityState"])
...
class ReportingApiEndpointsChangedForOrigin:
    ...
    **EXPERIMENTAL**
    ...
    def from_json(cls, json: T_JSON_DICT) -> ReportingApiEndpointsChangedForOrigin:
        return cls(
            origin=str(json["origin"]), endpoints=[ReportingApiEndpoint.from_json(i) for i in json["endpoints"]]
        )
