...
class StickyPositionConstraint:
    ...
    def from_json(cls, json):
        return cls(
            ...
            nearest_layer_shifting_sticky_box=LayerId.from_json(json["nearestLayerShiftingStickyBox"])
            if "nearestLayerShiftingStickyBox" in json
            else None,
            nearest_layer_shifting_containing_block=LayerId.from_json(json["nearestLayerShiftingContainingBlock"])
...
class Layer:
    ...
    def from_json(cls, json):
        return cls(
            ...
            sticky_position_constraint=StickyPositionConstraint.from_json(json["stickyPositionConstraint"])
