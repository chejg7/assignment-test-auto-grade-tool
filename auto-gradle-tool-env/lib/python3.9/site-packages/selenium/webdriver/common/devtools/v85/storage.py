...
def set_cookies(
    cookies: typing.List[network.CookieParam], browser_context_id: typing.Optional[browser.BrowserContextID] = None
...
def get_usage_and_quota(
    ...
    json = yield cmd_dict
    return (float(json["usage"]), float(json["quota"]), [UsageForType.from_json(i) for i in json["usageBreakdown"]])
...
class CacheStorageContentUpdated:
    ...
    def from_json(cls, json: T_JSON_DICT) -> CacheStorageContentUpdated:
        return cls(origin=str(json["origin"]), cache_name=str(json["cacheName"]))
...
class CacheStorageListUpdated:
    ...
    def from_json(cls, json: T_JSON_DICT) -> CacheStorageListUpdated:
        return cls(origin=str(json["origin"]))
