...
class CertificateSecurityState:
    ...
    def from_json(cls, json):
        return cls(
            ...
            certificate_network_error=str(json["certificateNetworkError"])
...
class VisibleSecurityState:
    ...
    def from_json(cls, json):
        return cls(
            ...
            certificate_security_state=CertificateSecurityState.from_json(json["certificateSecurityState"])
...
class CertificateError:
    ...
    def from_json(cls, json: T_JSON_DICT) -> CertificateError:
        return cls(
            event_id=int(json["eventId"]), error_type=str(json["errorType"]), request_url=str(json["requestURL"])
        )
