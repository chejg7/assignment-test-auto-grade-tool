...
def clear_object_store(
    security_origin: str, database_name: str, object_store_name: str
...
def delete_database(security_origin: str, database_name: str) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    """
    Deletes a database.
...
def delete_object_store_entries(
    security_origin: str, database_name: str, object_store_name: str, key_range: KeyRange
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    """
...
def request_database(
    security_origin: str, database_name: str
