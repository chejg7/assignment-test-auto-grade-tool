...
class TargetInfo:
    ...
    def from_json(cls, json):
        return cls(
            ...
            browser_context_id=browser.BrowserContextID.from_json(json["browserContextId"])
...
def detach_from_target(
    session_id: typing.Optional[SessionID] = None, target_id: typing.Optional[TargetID] = None
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    """
...
def send_message_to_target(
    message: str, session_id: typing.Optional[SessionID] = None, target_id: typing.Optional[TargetID] = None
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    """
...
def set_auto_attach(
    auto_attach: bool, wait_for_debugger_on_start: bool, flatten: typing.Optional[bool] = None
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    """
...
def auto_attach_related(
    target_id: TargetID, wait_for_debugger_on_start: bool
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    """
...
def set_discover_targets(discover: bool) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    """
