...
class UserAgentMetadata:
    ...
    def from_json(cls, json):
        return cls(
            ...
            full_version_list=[UserAgentBrandVersion.from_json(i) for i in json["fullVersionList"]]
...
def set_emulated_media(
    media: typing.Optional[str] = None, features: typing.Optional[typing.List[MediaFeature]] = None
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    """
