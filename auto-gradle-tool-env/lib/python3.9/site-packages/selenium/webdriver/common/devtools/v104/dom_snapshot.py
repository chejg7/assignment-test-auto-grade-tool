...
class DOMNode:
    ...
    def from_json(cls, json):
        return cls(
            ...
            event_listeners=[dom_debugger.EventListener.from_json(i) for i in json["eventListeners"]]
...
class LayoutTreeNode:
    ...
    def from_json(cls, json):
        return cls(
            ...
            inline_text_nodes=[InlineTextBox.from_json(i) for i in json["inlineTextNodes"]]
...
class NodeTreeSnapshot:
    ...
    def from_json(cls, json):
        return cls(
            ...
            backend_node_id=[dom.BackendNodeId.from_json(i) for i in json["backendNodeId"]]
            ...
            content_document_index=RareIntegerData.from_json(json["contentDocumentIndex"])
...
class LayoutTreeSnapshot:
    ...
    def from_json(cls, json):
        return cls(
            ...
            blended_background_colors=[StringIndex.from_json(i) for i in json["blendedBackgroundColors"]]
            if "blendedBackgroundColors" in json
            else None,
            text_color_opacities=[float(i) for i in json["textColorOpacities"]]
            if "textColorOpacities" in json
            else None,
        )
...
def capture_snapshot(
    ...
    json = yield cmd_dict
    return ([DocumentSnapshot.from_json(i) for i in json["documents"]], [str(i) for i in json["strings"]])
