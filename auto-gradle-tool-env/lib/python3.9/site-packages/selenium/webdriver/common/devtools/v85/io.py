...
def read(
    handle: StreamHandle, offset: typing.Optional[int] = None, size: typing.Optional[int] = None
    ...
    json = yield cmd_dict
    return (bool(json["base64Encoded"]) if "base64Encoded" in json else None, str(json["data"]), bool(json["eof"]))
