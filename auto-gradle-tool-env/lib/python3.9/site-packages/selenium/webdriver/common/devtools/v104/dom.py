...
class PseudoType(enum.Enum):
    ...
    PAGE_TRANSITION_IMAGE_WRAPPER = "page-transition-image-wrapper"
    PAGE_TRANSITION_OUTGOING_IMAGE = "page-transition-outgoing-image"
    PAGE_TRANSITION_INCOMING_IMAGE = "page-transition-incoming-image"
...
def copy_to(
    node_id: NodeId, target_node_id: NodeId, insert_before_node_id: typing.Optional[NodeId] = None
...
def get_nodes_for_subtree_by_style(
    node_id: NodeId, computed_styles: typing.List[CSSComputedStyleProperty], pierce: typing.Optional[bool] = None
...
def request_child_nodes(
    node_id: NodeId, depth: typing.Optional[int] = None, pierce: typing.Optional[bool] = None
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    """
...
def get_container_for_node(
    node_id: NodeId, container_name: typing.Optional[str] = None
...
class PseudoElementRemoved:
    ...
    **EXPERIMENTAL**
    ...
    def from_json(cls, json: T_JSON_DICT) -> PseudoElementRemoved:
        return cls(
            parent_id=NodeId.from_json(json["parentId"]), pseudo_element_id=NodeId.from_json(json["pseudoElementId"])
        )
...
class ShadowRootPopped:
    ...
    **EXPERIMENTAL**
    ...
    def from_json(cls, json: T_JSON_DICT) -> ShadowRootPopped:
        return cls(host_id=NodeId.from_json(json["hostId"]), root_id=NodeId.from_json(json["rootId"]))
