...
async def open_ssl_over_tcp_stream(
    ...
    *,
    ...
    """
    tcp_stream = await trio.open_tcp_stream(host, port, happy_eyeballs_delay=happy_eyeballs_delay)
...
async def open_ssl_over_tcp_listeners(port, ssl_context, *, host=None, https_compatible=False, backlog=None):
